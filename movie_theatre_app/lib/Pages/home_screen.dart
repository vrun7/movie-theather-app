...
import 'package:movie_theatre_app/Controllers/shared_pref.dart';
import 'package:movie_theatre_app/Pages/profile_screen.dart';
import 'package:movie_theatre_app/Pages/select_location_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String? picUrl = AuthController
        .instance.user!.photoURL; //it get it from email photo after authenicate
              ...
              child: GestureDetector(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    fit: BoxFit.cover,
                    imageUrl: picUrl, //image in appbar
                    height: 60,
                    width: 60,
                  ),
                ),
